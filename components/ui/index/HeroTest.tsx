            ...
            <div className="col-span-2 mx-auto max-w-2xl lg:max-w-none">
              <div className="isolate z-30 col-span-2 w-full lg:pr-8 lg:pt-4">
                <div className="relative isolate mx-auto -mt-20 flex h-[30rem] flex-col justify-center ">
                  <h1 className="mb-8 animate-fadeIn font-serif text-4xl font-light italic leading-10 opacity-0 delay-100 fill-mode-forwards sm:text-5xl">
                    Liquidation.
                  </h1>
                  <h1 className="mb-20 animate-[fadeIn_ease-in_1s] text-4xl font-light italic leading-10 opacity-0 delay-500 fill-mode-forwards sm:text-5xl">
                    Expertise.
                  </h1>
